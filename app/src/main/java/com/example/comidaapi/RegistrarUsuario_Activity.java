...
public class RegistrarUsuario_Activity extends AppCompatActivity {
    ...
    Button boton_registrar_usuario;
    Button boton_cancelar_usuario;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boton_registrar_usuario = findViewById(R.id.registro_registrar_usuario);
        boton_cancelar_usuario = findViewById(R.id.cancelar);
        ...
        boton_cancelar_usuario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        boton_registrar_usuario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),MainActivity.class);
                startActivity(intent);
